...
One box has a barrot in it. To win, you must have the box with the
carrot in it.

This is a very simple and silly game
      
The first plaer looks into their box first (the second player must close
their eyes during this.) The first player then sayys "There is a carrot
...
print(p1Name + ' here is the indisde of your box:')
